...
import { TrimmerOptions } from './interfaces';

import { AlsData, LogData, LogLevel, Logger } from '@pavelglaz/types'

import { defaultOptions } from './config'
import { trimmer } from './trimmer'

export default class AppLogger implements Logger {
  ...
  child(bindings: Record<string, unknown>, destinationStream?: DestinationStream): Logger {
    ...
    return new AppLogger(this.options, this.asyncLocalStorage, destinationStream, pinoLogger)
  }
